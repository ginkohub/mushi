...
const t = translate({
  ...
  id: {
    ...
    no_data: "❌ Data soal tidak ditemukan! Gunakan `{prefix}cl.update` (Admin).",
    question_header: "🍟 *CAK LONTONG*",
...
const JSON_URL = "https://raw.githubusercontent.com/MichaelAgam23/metadata/main/caklontong.json";
